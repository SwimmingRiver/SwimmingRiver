...
> 기능 구현을 넘어 사용자 입장에서 개선하는 프론트엔드 개발자입니다.
...
- 저장한 북마크를 AI가 자동으로 요약·태깅하고, 오늘 읽을 링크를 추천해주는 서비스
- **Next.js** · **Supabase** · **Claude API** · **TypeScript**
- 개발 중 — [GitHub Repo](https://github.com/SwimmingRiver/markhive)
...
![Emotion](https://img.shields.io/badge/Emotion-000?style=flat)
...
| | | |
|---|---|---|
| **STCLAB** | Frontend Developer Intern | 2025.01 ~ 2025.05 |
